...
console.log(
  " Rate limiting DISABLED for development - No 429 errors should occur",
);
...
app.use("/api/admin", require("./routes/adminOrders")); // Admin routes without auth
app.use("/dashboard", require("./routes/adminOrders")); // Admin panel routes
...
const startServer = async () => {
  try {
    ...
    app.listen(PORT, "0.0.0.0", () => {
      ...
      console.log(
        "MongoDB Connected:",
        process.env.MONGODB_URI ? "Successfully" : "Failed",
      );
