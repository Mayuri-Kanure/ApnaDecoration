...
const HelpSupport = () => {
  ...
  const handleSubmit = (e) => {
    ...
    navigate('/dashboard/support-ticket', { state: { formData } });
  };
  ...
  return (
    <Box sx={{ p: 3, maxWidth: 1200, mx: 'auto' }}>
      ...
      <Typography variant="body1" color="text.secondary" sx={{ mb: 4 }}>
        We're here to help! Get quick assistance for your orders, services, and account.
      </Typography>
        ...
        <Grid item xs={12} md={4}>
          <Card>
            <CardContent sx={{ textAlign: 'center', p: 3 }}>
              <MessageCircle className="w-8 h-8 mb-2" style={{ color: '#1976d2' }} />
              <Typography variant="h6" sx={{ mb: 1 }}>
                Live Chat
              </Typography>
              <Typography variant="body2" color="text.secondary">
