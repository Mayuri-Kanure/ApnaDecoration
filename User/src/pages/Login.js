...
import { sanitizeInput, sanitizeEmail, validatePassword, validateRequired, validateUsername } from '../utils/validation';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        if (!usernameValidation.valid || !firstNameValidation.valid || !lastNameValidation.valid) {
          setError(usernameValidation.message || firstNameValidation.message || lastNameValidation.message);
          setLoading(false);
          return;
        }
      ...
      if (err.message?.includes('Network') || err.message?.includes('fetch')) {
        ...
        setError('Login failed. Please check your credentials or register for a new account.');
      }
    } finally {
      setLoading(false);
    }
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-lg shadow-md hover:shadow-lg transition p-8">
            ...
            <div className="text-center mb-8">
              <h1 className="text-3xl font-bold tracking-tighter text-gray-900">APNA DECORATION</h1>
                ...
                <div className="ml-3">
                  ...
                  {error.includes('register for a new account') && (
                    <div className="mt-2 text-sm text-red-600">
                      ...
                      <p className="mt-1 text-xs">Click "Sign Up" below to create a new account</p>
                    </div>
                  )}
          ...
          {loginSuccess && (
            <div className="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg mb-6">
              <p className="font-medium">
                {isLogin ? 'Login successful! Redirecting to profile...' : 'Registration successful! Redirecting to profile...'}
              </p>
          ...
          {isLogin && !loginSuccess && (
            <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-blue-800">🧪 Test Account Credentials:</p>
                  <div className="mt-2 space-y-1">
                    <div className="bg-white px-3 py-2 rounded border border-blue-200">
                      <p className="text-xs font-mono text-gray-700">📧 Email: user@test.com</p>
                    </div>
                    <div className="bg-white px-3 py-2 rounded border border-blue-200">
                      <p className="text-xs font-mono text-gray-700">🔐 Password: TestUser123</p>
                    </div>
                  </div>
