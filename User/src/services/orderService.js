...
const orderService = {
  ...
  requestReturn: async (orderId, returnData) => {
    try {
      const response = await apiService.post(`/orders/${orderId}/return`, returnData);
      return response;
    } catch (error) {
  ...
  applyDiscountCode: async (orderId, discountCode) => {
    try {
      const response = await apiService.post(`/orders/${orderId}/apply-discount`, {
        discountCode
      });
      return response;
    } catch (error) {
  ...
  updateShippingAddress: async (orderId, addressData) => {
    try {
      const response = await apiService.put(`/orders/${orderId}/shipping-address`, addressData);
      return response;
    } catch (error) {
  ...
  scheduleDelivery: async (orderId, deliveryData) => {
    try {
      const response = await apiService.post(`/orders/${orderId}/schedule-delivery`, deliveryData);
      return response;
    } catch (error) {
