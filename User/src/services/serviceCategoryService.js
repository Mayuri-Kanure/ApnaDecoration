import apiService, { serviceCategoryApi } from './api';
...
const serviceCategoryService = {
  ...
  getServicesByCategory: async (categoryId, params = {}) => {
    try {
      const response = await apiService.getServicesByCategory(categoryId, params);
      return response;
    } catch (error) {
  ...
  createServiceCategory: async (categoryData) => {
    try {
      const response = await apiService.post('/service-categories', categoryData);
      return response;
    } catch (error) {
  ...
  updateServiceCategory: async (id, categoryData) => {
    try {
      const response = await apiService.put(`/service-categories/${id}`, categoryData);
      return response;
    } catch (error) {
  ...
  getSubcategories: async (categoryId) => {
    try {
      const response = await apiService.get(`/service-categories/${categoryId}/subcategories`);
      return response;
    } catch (error) {
  ...
  getPublicServiceCategories: async () => {
    try {
      ...
      console.log('🔍 ServiceCategoryService: SERVICE_CATEGORY_API_URL:', process.env.REACT_APP_SERVICE_CATEGORY_API_URL);
      const response = await serviceCategoryApi.get('/service-categories?homeCategory=true&status=active');
      ...
      console.error('❌ ServiceCategoryService: Error fetching public service categories:', error);
      throw error;
    }
  },
  ...
  getServiceCategoryWithPricing: async (id) => {
    try {
      const response = await apiService.get(`/service-categories/${id}/pricing`);
      return response;
    } catch (error) {
