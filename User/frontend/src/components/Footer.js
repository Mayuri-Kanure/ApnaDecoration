    ...
    <footer className="bg-gradient-to-r from-gray-800 to-gray-900 text-white border-t border-gray-700">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 text-center sm:text-left">
              ...
              />
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 to-cyan-400 bg-clip-text text-transparent">
                APNA DECORATION
              </h2>
            </div>
            <p className="text-gray-300 leading-relaxed text-sm sm:text-base">
              Premium printing solutions for businesses and individuals. We
              specialize in high-quality stickers, banners, business cards, and
              custom printing services that make your brand stand out.
            </p>
            ...
            <div className="flex justify-center sm:justify-start space-x-3 sm:space-x-4 mt-4">
              <a
                ...
                aria-label="Facebook"
                className="bg-gray-700 hover:bg-blue-600 text-gray-300 hover:text-white rounded-full p-3 shadow-lg transition-all duration-300 transform hover:scale-110"
              >
                <Facebook size={18} />
              </a>
              <a
                ...
                className="bg-gray-700 hover:bg-pink-600 text-gray-300 hover:text-white rounded-full p-3 shadow-lg transition-all duration-300 transform hover:scale-110"
              >
                <Instagram size={18} />
              </a>
              <a
                ...
                rel="noopener noreferrer"
                aria-label="Twitter"
                className="bg-gray-700 hover:bg-blue-400 text-gray-300 hover:text-white rounded-full p-3 shadow-lg transition-all duration-300 transform hover:scale-110"
              >
                <Twitter size={18} />
              </a>
            </div>
            ...
            <div className="space-y-3 mt-4 text-center sm:text-left">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-3 text-gray-300 hover:text-green-400 transition-all duration-300 transform hover:scale-105 hover:bg-green-900/20 px-3 py-2 rounded-lg focus:outline-none"
              >
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    to={link.to}
                    className="text-gray-300 hover:text-blue-400 hover:bg-blue-900/20 px-3 py-2 rounded-lg transition-all duration-300 transform hover:scale-105 focus:outline-none block"
                  >
                    {link.name}
                  </Link>
                </li>
            ...
            <ul className="space-y-2">
              {servicesLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    to={link.to}
                    className="text-gray-300 hover:text-purple-400 hover:bg-purple-900/20 px-3 py-2 rounded-lg transition-all duration-300 transform hover:scale-105 focus:outline-none block"
                  >
                    {link.name}
                  </Link>
                </li>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-12 border-t pt-8">
          <Link
            to="/products"
            className="flex items-center space-x-3 bg-gray-700 p-3 sm:p-4 rounded-xl hover:bg-gray-600 transition-colors duration-200 cursor-pointer"
          >
      ...
      <div className="bg-gray-950 border-t border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 text-xs mt-2 sm:mt-0">
            ...
            <Link to="/refund" className="text-gray-400 hover:text-blue-400">
              Refund
            </Link>
            <Link to="/shipping" className="text-gray-400 hover:text-blue-400">
              Shipping
            </Link>
          </div>
        </div>
