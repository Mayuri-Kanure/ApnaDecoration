...
const paymentMethodService = {
  // Get all user payment methods (with caching)
  getPaymentMethods: async () => {
    return cachedApiCall("paymentMethods", async () => {
      try {
  ...
  addDigitalWallet: async (walletData) => {
    try {
      const response = await apiService.post(
        "/payment-methods/digital-wallet",
        walletData,
      );
      return response;
    } catch (error) {
  ...
  getPaymentHistory: async (params = {}) => {
    try {
      const response = await apiService.get("/payment-methods/history", {
        params,
      });
      return response;
    } catch (error) {
  ...
  refundPayment: async (paymentId, refundData) => {
    try {
      const response = await apiService.post(
        `/payment-methods/${paymentId}/refund`,
        refundData,
      );
      return response;
    } catch (error) {
  ...
  getRefundStatus: async (refundId) => {
    try {
      const response = await apiService.get(
        `/payment-methods/refunds/${refundId}`,
      );
      return response;
    } catch (error) {
