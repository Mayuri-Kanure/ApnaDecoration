...
const FeaturedProducts = () => {
  ...
  }, [featuredProducts, searchTerm, priceRange, sortBy, showServicesOnly]);
                    ...
                    <button
                      ...
                      className={`text-sm font-medium transition-colors ${
                        showServicesOnly
                          ...
                          : "text-gray-600 hover:text-gray-700 px-3 py-1 rounded-full"
                      }`}
                    >
                      {showServicesOnly ? "सेविसेस" : "सेविसेस"}
                    </button>
                    <button
                        ...
                        >
                          ...
                          <div className="flex gap-2 justify-center">
                            ...
                            <button
                              ...
                              className="flex-1 bg-orange-500 text-white py-2 rounded-lg text-sm font-medium hover:bg-orange-600 transition-colors flex items-center justify-center gap-1"
                            >
                              <ArrowRight size={14} />
                              Buy
                            </button>
