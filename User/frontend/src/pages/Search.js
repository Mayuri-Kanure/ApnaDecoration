...
const SearchPage = () => {
  ...
  const fetchSuggestions = useCallback(async (searchQuery) => {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/products/search/suggestions?q=${encodeURIComponent(searchQuery)}`,
      );
      const data = await response.json();
  ...
  const performSearch = useCallback(
    async (searchQuery, page = 1, filters = {}) => {
      setLoading(true);
      setError(null);
      ...
      try {
        ...
        const response = await fetch(
          `${API_BASE_URL}/products/search?${params}`,
        );
        const data = await response.json();
            ...
            <Box sx={{ display: "flex", gap: 2, mb: 3, flexWrap: "wrap" }}>
              ...
              <FormControl size="small" sx={{ minWidth: 150 }}>
                ...
                >
                  ...
                  <MenuItem value="rating-high-low">
                    Rating: High to Low
                  </MenuItem>
                      ...
                      <CardContent>
                        ...
                        <Box sx={{ display: "flex", gap: 1 }}>
                          ...
                          <IconButton
                            ...
                            color={
                              isInWishlist(product.id) ? "error" : "default"
                            }
                          >
                            <Heart
                              size={20}
