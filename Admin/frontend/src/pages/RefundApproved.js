...
function RefundApproved() {
  ...
  const handleExport = () => {
    const csvContent = [
      ['ID', 'Customer Name', 'Order ID', 'Order Date', 'Amount', 'Reason', 'Status', 'Request Date', 'Approved Date'],
    ...
    a.href = url;
    a.download = 'approved-refunds.csv';
    a.click();
  ...
  return (
    <Box sx={{ p: 2, backgroundColor: '#f5f5f5', minHeight: '100vh' }}>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{ backgroundColor: '#e3f2fd', border: '1px solid #90caf9' }}>
            <CardContent sx={{ textAlign: 'center', py: 2 }}>
              ...
              <Typography variant="body2" sx={{ color: '#1565c0' }}>Total Amount</Typography>
            </CardContent>
          </Card>
        </Grid>
      </Grid>
            ...
            <Table>
              <TableHead sx={{ backgroundColor: '#fafafa' }}>
                <TableRow>
                  ...
                  <TableCell sx={{ fontWeight: 600, color: '#333', borderBottom: '1px solid #e0e0e0' }}>Approved Date</TableCell>
      ...
      <Dialog open={detailsDialogOpen} onClose={() => setDetailsDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>Approved Refund Request Details</DialogTitle>
        <DialogContent>
          {selectedRequest && (
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} md={6}>
                <Typography variant="body2" sx={{ color: '#666' }}>Approved Date:</Typography>
                <Typography variant="body1" sx={{ mb: 2 }}>{selectedRequest.approvedDate || '-'}</Typography>
              </Grid>
              <Grid item xs={12}>
