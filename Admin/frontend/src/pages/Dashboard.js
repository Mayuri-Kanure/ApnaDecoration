  ...
  const walletCards = [
    {
      ...
      amount: stats?.adminWallet?.inHouseEarning || 0,
      icon: <MoneyIcon />,
      color: "#2F66FF",
    },
    {
      title: "Commission Earned",
      amount: stats?.adminWallet?.commissionEarned || 0,
      icon: <TrendingUpIcon />,
      color: "#28C76F",
    },
    {
      title: "Delivery Charge Earned",
      amount: stats?.adminWallet?.deliveryChargeEarned || 0,
      icon: <ShippingIcon />,
      color: "#00CFE8",
    },
    {
      title: "Total Tax Collected",
      amount: stats?.adminWallet?.totalTaxCollected || 0,
      icon: <TaxIcon />,
      color: "#FF9F43",
    },
    {
      title: "Pending Amount",
      amount: stats?.adminWallet?.pendingAmount || 0,
      icon: <WalletIcon />,
      color: "#EA5455",
    },
  ];
              ...
              <Grid item xs={12} sm={6} md={3} key={index}>
                ...
                >
                  <Box display="flex" alignItems="center">
                    <Box sx={{ color: status.color, mr: 1 }}>{status.icon}</Box>
        ...
        <Grid container spacing={3}>
          {walletCards.slice(0, 4).map((wallet, index) => (
            <Grid item xs={12} sm={6} md={3} key={index}>
              ...
              >
                <Box sx={{ color: wallet.color, mb: 1 }}>{wallet.icon}</Box>
                <Typography
                  variant="h5"
                  sx={{ fontWeight: 700, color: "#1e293b" }}
                >
              ...
              >
                <Box display="flex" alignItems="center">
                  ...
                  <Box>
                    ...
                    >
                      ₹
                      {(walletCards[4].amount || 0).toLocaleString("en-IN", {
                        minimumFractionDigits: 2,
                        maximumFractionDigits: 2,
                      })}
                    </Typography>
          ...
          >
            ...
            {stats?.popularStores?.length > 0 ? (
              ...
              >
                ...
                <Typography variant="body2" color="#64748B">
                  No popular stores data available
                </Typography>
              </Box>
            )}
          </Card>
              ...
              {stats?.popularProducts?.map((product, index) => (
                <Grid item xs={12} sm={6} key={index}>
                  ...
                  >
                    ...
                    >
                      <StarIcon
                        sx={{ fontSize: 16, color: "#FF9F43", mr: 0.5 }}
                      />
              ...
              <Box textAlign="center">
                ...
                <Box display="flex" flexDirection="column" gap={1}>
                  ...
                  >
                    ...
                    />
                    <Typography variant="caption">
                      Total Customer ({stats?.userOverview?.totalCustomers || 0}
                      )
                    </Typography>
                  </Box>
                  <Box
                  ...
                  >
                    ...
                    />
                    <Typography variant="caption">
                      Total Vendor ({stats?.userOverview?.totalVendors || 0})
                    </Typography>
                  </Box>
                  <Box
                    display="flex"
                  ...
                  >
                    ...
                    <Typography variant="caption">
                      Total Delivery Man (
                      {stats?.userOverview?.totalDeliveryMen || 0})
                    </Typography>
                  </Box>
                </Box>
              </Box>
