...
const BusinessSettings = () => {
  ...
  const [form, setForm] = useState({
    ...
    // Company Information
    companyName: 'PrintForMee',
    companyPhone: '+91 9167655524',
    companyEmail: 'officialprintformee@gmail.com',
    country: 'India',
    timezone: 'UTC',
    language: 'English (En)',
    companyAddress: 'dahanukarwadi, Kandivali W Mumbai. 400067',
    latitude: '25.477972917173002',
    longitude: '77.08692478435658',
  ...
  useEffect(() => {
axios.get(`${API}/admin/settings`, auth())
...
Object.keys(form).forEach(k => form[k] !== null && fd.append(k, form[k]));
await axios.post(`${API}/admin/settings`, fd, auth());
