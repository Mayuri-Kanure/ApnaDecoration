...
function RefundRejected() {
  ...
  const handleExport = () => {
    const csvContent = [
      ['ID', 'Customer Name', 'Order ID', 'Order Date', 'Amount', 'Reason', 'Status', 'Request Date', 'Rejected Date', 'Rejection Reason'],
    ...
    a.href = url;
    a.download = 'rejected-refunds.csv';
    a.click();
  ...
  return (
    <Box sx={{ p: 2, backgroundColor: '#f5f5f5', minHeight: '100vh' }}>
            ...
            <Table>
              <TableHead sx={{ backgroundColor: '#fafafa' }}>
                <TableRow>
                  ...
                  <TableCell sx={{ fontWeight: 600, color: '#333', borderBottom: '1px solid #e0e0e0' }}>Rejected Date</TableCell>
      ...
      <Dialog open={detailsDialogOpen} onClose={() => setDetailsDialogOpen(false)} maxWidth="md" fullWidth>
        <DialogTitle>Rejected Refund Request Details</DialogTitle>
        <DialogContent>
          {selectedRequest && (
            <Grid container spacing={2}>
              ...
              <Grid item xs={12} md={6}>
                <Typography variant="body2" sx={{ color: '#666' }}>Rejected Date:</Typography>
                <Typography variant="body1" sx={{ mb: 2 }}>{selectedRequest.rejectedDate || '-'}</Typography>
              </Grid>
              <Grid item xs={12}>
                <Typography variant="body2" sx={{ color: '#666' }}>Customer Reason:</Typography>
                <Typography variant="body1" sx={{ mb: 2 }}>{selectedRequest.reason}</Typography>
              </Grid>
              <Grid item xs={12}>
                <Typography variant="body2" sx={{ color: '#666' }}>Rejection Reason:</Typography>
              ...
              <Grid item xs={12}>
                ...
                <Chip 
                  ...
                  size="small"
                  sx={{ 
                    backgroundColor: getStatusBgColor('rejected'),
                    color: getStatusColor('rejected'),
                    borderColor: getStatusColor('rejected'),
                    fontWeight: 500
                  }}
                />
              </Grid>
