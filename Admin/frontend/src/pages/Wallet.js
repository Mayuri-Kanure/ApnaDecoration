...
function Wallet() {
  ...
  }, [searchQuery, transactionType, page, filters.dateFrom, filters.dateTo, filters.customer]);
  ...
  const handleAddFund = async () => {
    if (!selectedCustomer || !fundAmount) {
      setSnackbar({ open: true, message: 'Please select customer and enter amount', severity: 'error' });
      return;
    }
    ...
    try {
      ...
      setSnackbar({ open: true, message: 'Error adding funds', severity: 'error' });
    }
  };
  ...
  return (
    <Box sx={{ p: 3, backgroundColor: '#F8F9FB', minHeight: '100vh' }}>
        ...
        <Grid item xs={12} sm={6} md={4}>
          <Card sx={{ 
            ...
            <CardContent sx={{ p: 3, textAlign: 'center' }}>
              ...
              <Typography variant="body2" sx={{ color: '#E65100' }}>Debit</Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} sm={6} md={4}>
          <Card sx={{ 
            ...
            <CardContent sx={{ p: 3, textAlign: 'center' }}>
              ...
              <Typography variant="body2" sx={{ color: '#1565C0' }}>Credit</Typography>
            </CardContent>
          </Card>
        </Grid>
        <Grid item xs={12} sm={6} md={4}>
          <Card sx={{ 
            ...
            <CardContent sx={{ p: 3, textAlign: 'center' }}>
              ...
              <Typography variant="h5" sx={{ color: '#388E3C', fontWeight: 600, mb: 0.5 }}>
                {formatCurrency(closingBalance)}
              </Typography>
              <Typography variant="body2" sx={{ color: '#2E7D32' }}>Balance</Typography>
            </CardContent>
          </Card>
        </Grid>
      </Grid>
      ...
      {/* Add Fund Dialog */}
      <Dialog open={addFundDialogOpen} onClose={() => setAddFundDialogOpen(false)} maxWidth="sm" fullWidth>
        ...
        <DialogActions>
          ...
          <Button onClick={handleAddFund} variant="contained">Add Fund</Button>
        </DialogActions>
      </Dialog>
