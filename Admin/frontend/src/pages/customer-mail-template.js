...
const CustomerMailTemplate = () => {
  ...
  const handleSave = () => {
    ...
    console.log('Saving customer mail template:', { template, subject, body, variables, isActive });
    setSnackbar({ open: true, message: 'Customer mail template saved successfully', severity: 'success' });
  };
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                helperText="Available variables: {{customer_name}}, {{order_id}}, {{order_date}}"
                sx={{ mb: 2 }}
              />
            </Grid>
...
export default CustomerMailTemplate;
