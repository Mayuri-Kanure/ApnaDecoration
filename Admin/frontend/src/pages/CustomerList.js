...
const CustomerList = () => {
  ...
  const handleSaveCustomer = (updatedCustomer) => {
    setCustomers(
      customers
        ...
        .map((customer, index) => <div key={customer.id}>{/* content */}</div>),
    );
    setNotification({
      open: true,
  ...
  const handleBlockToggle = async (customerId, currentStatus) => {
    try {
      ...
      setCustomers(
        customers
          .map((c) => (c.id === customerId ? { ...c, status: newStatus } : c))
          .map((customer, index) => (
  ...
  return (
    <Box sx={{ p: 3, backgroundColor: "#f4f6f9", minHeight: "100vh" }}>
      ...
      {/* Customer List Table */}
      <Card
        sx={{ boxShadow: "0 4px 12px rgba(0, 0, 0, 0.08)", borderRadius: 3 }}
      >
        <CardContent sx={{ p: 3 }}>
          <Box
            sx={{
                  ...
                  >
                    ...
                    <TableCell align="center">
                      <Chip
                        ...
                        size="small"
                        sx={{
                          backgroundColor: getOrderBadgeColor(
                    ...
                    <TableCell align="center">
                      <Switch
                        ...
                        onChange={() =>
                          handleBlockToggle(customer._id, customer.status)
                        }
                        color="error"
                      />
                    </TableCell>
      ...
      <ViewCustomerDialog
        ...
        customerId={
          selectedCustomer && selectedCustomer.id ? selectedCustomer.id : null
        }
      />
