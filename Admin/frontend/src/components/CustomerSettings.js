...
const CustomerSettings = () => {
  ...
  const handleChange = (field, value) => {
    ...
    if (
      field === "customerWalletEnabled" ||
      field === "addRefundAmountToWallet" ||
      field === "addFundToWallet" ||
      field === "customerLoyaltyPointsEnabled" ||
      field === "referralFeatureEnabled"
    ) {
      const fieldLabels = {
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={4}>
              ...
              <Switch
                ...
                onChange={(e) =>
                  handleChange("customerWalletEnabled", e.target.checked)
                }
                color="primary"
              />
            </Grid>
            ...
            <Grid item xs={12} md={4}>
              ...
              <Switch
                ...
                onChange={(e) =>
                  handleChange("customerLoyaltyPointsEnabled", e.target.checked)
                }
                color="primary"
              />
            </Grid>
            ...
            <Grid item xs={12} md={4}>
              ...
              <Switch
                ...
                onChange={(e) =>
                  handleChange("referralFeatureEnabled", e.target.checked)
                }
                color="primary"
              />
            </Grid>
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={6}>
              ...
              <Switch
                ...
                onChange={(e) =>
                  handleChange("addRefundAmountToWallet", e.target.checked)
                }
                color="primary"
              />
            </Grid>
            ...
            <Grid item xs={12} md={6}>
              ...
              <Switch
                ...
                onChange={(e) =>
                  handleChange("addFundToWallet", e.target.checked)
                }
                color="primary"
              />
            </Grid>
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={(e) =>
                  handleChange("minimumAddFundAmount", e.target.value)
                }
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={(e) =>
                  handleChange("maximumAddFundAmount", e.target.value)
                }
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={4}>
              <TextField
                ...
                onChange={(e) =>
                  handleChange("equivalentPointToCurrency", e.target.value)
                }
            ...
            <Grid item xs={12} md={4}>
              <TextField
                ...
                onChange={(e) =>
                  handleChange("loyaltyPointEarnOnEachOrder", e.target.value)
                }
            ...
            <Grid item xs={12} md={4}>
              <TextField
                ...
                onChange={(e) =>
                  handleChange("minimumPointRequiredToConvert", e.target.value)
                }
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={6}>
              <TextField
                ...
                onChange={(e) =>
                  handleChange("earningsToEachReferral", e.target.value)
                }
