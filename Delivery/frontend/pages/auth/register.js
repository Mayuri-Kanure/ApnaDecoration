...
const validateForm = (formData) => {
  ...
  const bankNameValid = formData.bankName?.trim() !== '' ? { isValid: true } : { isValid: false, error: 'Bank name is required' };
...
const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_DELIVERY_API_URL}/register`, {
        method: 'POST',
    ...
    switch (step) {
      ...
      case 1:
        return (
          <Grid container spacing={2}>
            <Grid item xs={12}>
              <InputLabel sx={{ mb: 1, color: '#1e3a5f' }}>Vehicle Type *</InputLabel>
              <Select
                fullWidth
                name="vehicleType"
            ...
            <Grid item xs={12}>
              <TextField
                ...
                margin="normal"
                InputProps={{
                  startAdornment: <LocalShipping sx={{ mr: 1, color: '#1e3a5f' }} />
                }}
              />
            </Grid>
            <Grid item xs={12}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                margin="normal"
                InputProps={{
                  startAdornment: <AccountBalance sx={{ mr: 1, color: '#1e3a5f' }} />
                }}
              />
            </Grid>
            <Grid item xs={12} sm={6}>
        ...
        return (
          <Box sx={{ textAlign: 'center', py: 2 }}>
            ...
            <Typography variant="body2" sx={{ mb: 3, color: '#666' }}>
              By registering as a delivery boy, you agree to our terms of service, 
              privacy policy, and commit to providing reliable delivery services 
              to our customers.
            </Typography>
            <FormControlLabel
              control={
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Register as delivery boy for APNA Decoration" />
