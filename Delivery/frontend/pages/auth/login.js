...
export default function DeliveryBoyLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/delivery-boy/login`, {
        method: 'POST',
        headers: {
      ...
      if (response.ok) {
        ...
        localStorage.setItem('deliveryBoyUser', JSON.stringify(data.data.deliveryBoy));
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Login to APNA Decoration delivery boy portal" />
