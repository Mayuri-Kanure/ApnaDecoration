...
export default function EarningsPage() {
  ...
  const getFilteredEarnings = () => {
    ...
    if (filter === "completed")
      return earnings.filter((e) => e.status === "completed");
    if (filter === "pending")
      return earnings.filter((e) => e.status === "pending");
    if (filter === "withdrawal")
      return earnings.filter((e) => e.type === "withdrawal");
    return earnings;
  };
    ...
    >
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{ backgroundColor: "#2196F3", color: "white" }}>
            <CardContent>
              ...
              <Typography variant="h4">
                ₹{earningsStats.totalWithdrawals}
              </Typography>
        ...
        <Grid item xs={12} sm={6} md={3}>
          <Card sx={{ backgroundColor: "#FF9800", color: "white" }}>
            <CardContent>
              ...
              <Typography variant="h4">
                {earningsStats.pendingWithdrawals}
              </Typography>
              <Pending sx={{ mt: 1 }} />
            </CardContent>
          </Card>
      ...
      >
        ...
        >
          <Tab
            ...
            label={isMobile ? "Earnings" : "Earnings History"}
          />
          <Tab
            icon={<History />}
            label={isMobile ? "Withdraw" : "Withdrawal History"}
          />
            ...
            {isMobile ? (
              <Box>
                {getFilteredEarnings().map((earning) => (
                  <Card key={earning.id} sx={{ mb: 2, p: 2, boxShadow: 2 }}>
                    <Box
                      sx={{
                        display: "flex",
                    ...
                    <Typography variant="h6" sx={{ mb: 0.5, color: "#2F66FF" }}>
                      ₹{earning.amount}
                    </Typography>
      ...
      >
        ...
        <DialogActions>
          ...
          <Button onClick={handleWithdrawal} variant="contained">
            Request
          </Button>
        </DialogActions>
      </Dialog>
